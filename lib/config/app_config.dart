...
class AppConfig {
  ...
  static String get apiBaseUrlAndroid {
    try {
      return dotenv.env['API_BASE_URL_ANDROID'] ?? 'http://10.0.2.2:3000/assets';
    } catch (e) {
      // Fallback for test environment where dotenv is not initialized
      return 'http://test.example.com/assets';
    }
  }
